...
const appointmentIcon = document.querySelector('.icon-btn[title="Appointments"]');
...
if (appointmentIcon && appointmentPopup) {
    ...
    document.addEventListener('mousedown', function(e) {
        if (!appointmentPopup.contains(e.target) && !appointmentIcon.contains(e.target)) {
            appointmentPopup.classList.remove('active');
        }
    });
}
...
const appointmentCheckListLink = document.getElementById('appointment-check-list-link');
const appointmentEditAppointmentLink = document.getElementById('appointment-edit-appointment-link');
